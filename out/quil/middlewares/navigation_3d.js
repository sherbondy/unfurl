...
var vec__8158 = axis;
var a_x = cljs.core.nth.call(null,vec__8158,(0),null);
var a_y = cljs.core.nth.call(null,vec__8158,(1),null);
var a_z = cljs.core.nth.call(null,vec__8158,(2),null);
var vec__8159 = v;
var x = cljs.core.nth.call(null,vec__8159,(0),null);
var y = cljs.core.nth.call(null,vec__8159,(1),null);
var z = cljs.core.nth.call(null,vec__8159,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8160,p__8161){
var vec__8164 = p__8160;
var u1 = cljs.core.nth.call(null,vec__8164,(0),null);
var u2 = cljs.core.nth.call(null,vec__8164,(1),null);
var u3 = cljs.core.nth.call(null,vec__8164,(2),null);
var vec__8165 = p__8161;
var v1 = cljs.core.nth.call(null,vec__8165,(0),null);
var v2 = cljs.core.nth.call(null,vec__8165,(1),null);
var v3 = cljs.core.nth.call(null,vec__8165,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8166_SHARP_){
return (p1__8166_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8167_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8168_SHARP_,angle_lr),angle_ud);
...
var map__8175 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__8175__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8175__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__8177 = cljs.core._EQ_;
var expr__8178 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8177.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8178))){
return straight;
} else {
if(cljs.core.truth_(pred__8177.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8178))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8177.call(null,quil.middlewares.navigation_3d.space,expr__8178))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8177.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8178))){
return up;
} else {
if(cljs.core.truth_(pred__8177.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8178))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8177.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8178))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__8175,map__8175__$1,up,straight){
return (function (p1__8169_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8169_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__8175,map__8175__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8180_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8186_8191 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8186_8192__$1 = ((((!((map__8186_8191 == null)))?((((map__8186_8191.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8186_8191.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8186_8191):map__8186_8191);
var vec__8187_8193 = cljs.core.get.call(null,map__8186_8192__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8194 = cljs.core.nth.call(null,vec__8187_8193,(0),null);
var c_y_8195 = cljs.core.nth.call(null,vec__8187_8193,(1),null);
var c_z_8196 = cljs.core.nth.call(null,vec__8187_8193,(2),null);
var vec__8188_8197 = cljs.core.get.call(null,map__8186_8192__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8198 = cljs.core.nth.call(null,vec__8188_8197,(0),null);
var u_y_8199 = cljs.core.nth.call(null,vec__8188_8197,(1),null);
var u_z_8200 = cljs.core.nth.call(null,vec__8188_8197,(2),null);
var vec__8189_8201 = cljs.core.get.call(null,map__8186_8192__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8202 = cljs.core.nth.call(null,vec__8189_8201,(0),null);
var p_y_8203 = cljs.core.nth.call(null,vec__8189_8201,(1),null);
var p_z_8204 = cljs.core.nth.call(null,vec__8189_8201,(2),null);
quil.core.camera.call(null,p_x_8202,p_y_8203,p_z_8204,(p_x_8202 + c_x_8194),(p_y_8203 + c_y_8195),(p_z_8204 + c_z_8196),u_x_8198,u_y_8199,u_z_8200);
